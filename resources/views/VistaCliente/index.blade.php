...
<div class="w-full px-6 mx-auto">
    <div class="relative flex items-center p-0 mt-6 overflow-hidden bg-center bg-cover min-h-75 rounded-2xl"
        style="background-image: url('../../../public/assets/img/curved-images/curved0.jpg'); background-position-y: 50%">
        <span
...
<div class="flex-none w-full max-w-full px-3 mt-6">
    <div
        ...
        <div class="p-4 pb-0 mb-0 bg-white rounded-t-2xl">
            <h6 class="mb-1">Albumes de Eventos</h6>
                    ...
                    <div
                        ...
                        <div class="flex-auto px-1 pt-6 ">
                            ...
                            <div class="flex items-center justify-between " >
                                <button type="button"
                                    class="mx-auto text-center inline-block px-8 py-2 mb-2 font-bold text-center uppercase align-middle transition-all bg-transparent border border-solid rounded-lg shadow-none cursor-pointer leading-pro ease-soft-in text-xs hover:scale-102 active:shadow-soft-xs tracking-tight-soft border-fuchsia-500 text-fuchsia-500 hover:border-fuchsia-500 hover:bg-transparent hover:text-fuchsia-500 hover:opacity-75 hover:shadow-none active:bg-fuchsia-500 active:text-white active:hover:bg-transparent active:hover:text-fuchsia-500">View
                                    Project</button>
                ...
                <div class="w-full max-w-full px-3 mb-6 md:w-6/12 md:flex-none xl:mb-0 xl:w-3/12">
                    <div
                        ...
                        <div class="flex-auto px-1 pt-6">
                            ...
                            <div class="flex items-center justify-between">
                                <button type="button"
                                    class="mx-auto text-center inline-block px-8 py-2 mb-0 font-bold text-center uppercase align-middle transition-all bg-transparent border border-solid rounded-lg shadow-none cursor-pointer leading-pro ease-soft-in text-xs hover:scale-102 active:shadow-soft-xs tracking-tight-soft border-fuchsia-500 text-fuchsia-500 hover:border-fuchsia-500 hover:bg-transparent hover:text-fuchsia-500 hover:opacity-75 hover:shadow-none active:bg-fuchsia-500 active:text-white active:hover:bg-transparent active:hover:text-fuchsia-500">View
                                    Project</button>
